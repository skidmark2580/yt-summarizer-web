...
def fetch_transcript(video_id):
    ...
    for langs in [['ko'], ['en'], None]:
        try:
            ...
            last_err = e
            continue
    raise last_err or Exception("자막을 찾을 수 없습니다.")


def build_prompt(transcript, lang_label="한국어"):
    return f"""아래 유튜브 영상 자막을 분석해서 {lang_label}로 정확히 아래 JSON 형식으로만 응답하세요.
